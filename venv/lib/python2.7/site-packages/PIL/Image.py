...
class Image(object):
    ...
    * :py:func:`~PIL.Image.frombytes`
    ...
    def _crop(self, im, box):
        ...
        x0, y0, x1, y1 = list(map(int, list(map(round, box))))
    ...
    def split(self):
        ...
        if self.im.bands == 1:
            ...
            ims = list(map(self._new, self.im.split()))
        return tuple(ims)
...
class Exif(MutableMapping):
    ...
    def _fixup_dict(self, src_dict):
        ...
        return {k: self._fixup(v) for k, v in list(src_dict.items())}
    ...
    def load(self, data):
        ...
        self.fp.seek(self._info.__next__)
