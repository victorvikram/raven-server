    ...
    def add_graph_element(self, G):
        ...
        if graphid is None:
            ...
            graph_element = self.myElement("graph",
                                           ...
                                           id=graphid)
        default = {}
        data = {k: v for (k, v) in list(G.graph.items())
        ...
        # See self.attr_type
        for (xml_obj, data) in list(self.attributes.items()):
...
class GraphMLWriterLxml(GraphMLWriter):
    ...
    def add_graph_element(self, G):
        ...
        graphdata = {k: v for k, v in list(G.graph.items())
                     if k not in ('node_default', 'edge_default')}
        node_default = G.graph.get('node_default', {})
        edge_default = G.graph.get('edge_default', {})
        # Graph attributes
        for k, v in list(graphdata.items()):
