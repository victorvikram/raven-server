...
def asyn_fluidc(G, k, max_iter=100, seed=None):
    ...
    density = {}
    com_to_numvertices = {}
    for vertex in list(communities.keys()):
    ...
    while cont:
        ...
        for vertex in vertices:
            ...
            new_com = -1
            if len(list(com_counter.keys())) > 0:
                max_freq = max(com_counter.values())
                best_communities = [com for com, freq in list(com_counter.items())
    ...
    return iter(list(groups(communities).values()))
