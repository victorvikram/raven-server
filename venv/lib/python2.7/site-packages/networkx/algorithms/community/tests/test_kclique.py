...
def test_overlapping_K5():
    ...
    assert_equal(c, [frozenset(list(range(7)))])
    c = set(k_clique_communities(G, 5))
    assert_equal(c, {frozenset(list(range(5))), frozenset(list(range(2, 7)))})
...
def test_isolated_K5():
    ...
    c = set(k_clique_communities(G, 5))
    assert_equal(c, {frozenset(list(range(5))), frozenset(list(range(5, 10)))})
