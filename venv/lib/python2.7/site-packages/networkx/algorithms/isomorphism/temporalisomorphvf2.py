    ...
    def one_hop(self, Gx, Gx_node, neighbors):
        ...
        for n in neighbors:
            if type(Gx) == type(nx.Graph()):  # Graph G[u][v] returns the data dictionary.
                ...
                for edge in list(Gx[Gx_node][n].values()):  # Iterates all edges between node pair.
...
class TimeRespectingDiGraphMatcher(DiGraphMatcher):
    ...
    def get_pred_dates(self, Gx, Gx_node, core_x, pred):
        ...
        if type(Gx) == type(nx.DiGraph()):  # Graph G[u][v] returns the data dictionary.
            ...
            for n in pred:
                for edge in list(Gx[n][Gx_node].values()):  # Iterates all edge data between node pair.
    ...
    def get_succ_dates(self, Gx, Gx_node, core_x, succ):
        ...
        if type(Gx) == type(nx.DiGraph()):  # Graph G[u][v] returns the data dictionary.
            ...
            for n in succ:
                for edge in list(Gx[Gx_node][n].values()):  # Iterates all edge data between node pair.
