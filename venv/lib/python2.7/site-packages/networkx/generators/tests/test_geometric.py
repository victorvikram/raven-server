...
class TestRandomGeometricGraph(object):
    ...
    def test_number_of_nodes(self):
        ...
        G = nx.random_geometric_graph(list(range(50)), 0.25, seed=42)
        assert_equal(len(G), 50)
...
class TestSoftRandomGeometricGraph(object):
    ...
    def test_number_of_nodes(self):
        ...
        assert_equal(len(G), 50)
        G = nx.soft_random_geometric_graph(list(range(50)), 0.25, seed=42)
        assert_equal(len(G), 50)
...
class TestGeographicalThresholdGraph(object):
    ...
    def test_number_of_nodes(self):
        ...
        assert_equal(len(G), 50)
        G = nx.geographical_threshold_graph(list(range(50)), 100, seed=42)
        assert_equal(len(G), 50)
...
class TestWaxmanGraph(object):
    ...
    def test_number_of_nodes_1(self):
        ...
        assert_equal(len(G), 50)
        G = nx.waxman_graph(list(range(50)), 0.5, 0.1, seed=42)
        assert_equal(len(G), 50)

    def test_number_of_nodes_2(self):
        G = nx.waxman_graph(50, 0.5, 0.1, L=1)
        assert_equal(len(G), 50)
        G = nx.waxman_graph(list(range(50)), 0.5, 0.1, L=1)
        assert_equal(len(G), 50)
...
class TestThresholdedRandomGeometricGraph(object):
    ...
    def test_number_of_nodes(self):
        ...
        assert_equal(len(G), 50)
        G = nx.thresholded_random_geometric_graph(list(range(50)), 0.2, 0.1)
        assert_equal(len(G), 50)
