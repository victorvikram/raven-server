...
class TestChainsOfViews(object):
    ...
    def test_subgraph_of_subgraph(self):
        SGv = nx.subgraph(self.G, list(range(3, 7)))
        SDGv = nx.subgraph(self.DG, list(range(3, 7)))
        SMGv = nx.subgraph(self.MG, list(range(3, 7)))
        SMDGv = nx.subgraph(self.MDG, list(range(3, 7)))
