...
class TestNodeViewSetOps(object):
    ...
    def test_and(self):
        ...
        nv = self.nv
        some_nodes = self.n_its(list(range(5, 12)))
        assert_equal(nv & some_nodes, self.n_its(list(range(5, 9))))
        assert_equal(some_nodes & nv, self.n_its(list(range(5, 9))))

    def test_or(self):
        # print("G | H nodes:", gnv | hnv)
        nv = self.nv
        some_nodes = self.n_its(list(range(5, 12)))
        assert_equal(nv | some_nodes, self.n_its(list(range(12))))
        assert_equal(some_nodes | nv, self.n_its(list(range(12))))
    ...
    def test_sub(self):
        ...
        nv = self.nv
        some_nodes = self.n_its(list(range(5, 12)))
        assert_equal(nv - some_nodes, self.n_its(list(range(5))))
        assert_equal(some_nodes - nv, self.n_its(list(range(9, 12))))
