...
class MultiGraph(Graph):
    ...
    **Subclasses (Advanced):**
    ...
    def copy(self, as_view=False):
        ...
        G.add_nodes_from((n, d.copy()) for n, d in list(self._node.items()))
    ...
    def to_directed(self, as_view=False):
        ...
        G.add_nodes_from((n, deepcopy(d)) for n, d in list(self._node.items()))
        G.add_edges_from((u, v, key, deepcopy(datadict))
                         for u, nbrs in list(self.adj.items())
                         for v, keydict in list(nbrs.items())
                         for key, datadict in list(keydict.items()))
        return G
