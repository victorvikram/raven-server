        ...
        with tempdir() as tmpdir:
            for suffix in suffixes:
                ...
                b = np.loadtxt(os.path.join(tmpdir, 'test.csv' + suffix),
                               encoding='UTF-16-LE', dtype=np.str)
                assert_array_equal(a, b)
...
class LoadTxtBase(object):
    ...
    def test_stringload(self):
        ...
        with temppath() as path:
            ...
            x = self.loadfunc(path, encoding="UTF-16", dtype=np.str)
            assert_array_equal(x, nonascii)

    def test_binary_decode(self):
        utf16 = b'\xff\xfeh\x04 \x00i\x04 \x00j\x04'
        v = self.loadfunc(BytesIO(utf16), dtype=np.str, encoding='UTF-16')
    ...
    def test_converters_decode(self):
        ...
        c.write(b'\xcf\x96')
        c.seek(0)
        x = self.loadfunc(c, dtype=np.str,
    ...
    def test_converters_nodecode(self):
        ...
        with temppath() as path:
            with io.open(path, 'wt', encoding='UTF-8') as f:
                f.write(utf8)
            x = self.loadfunc(path, dtype=np.str,
    ...
    def test_binary_load(self):
        ...
        with temppath() as path:
            ...
            with open(path, "rb") as f:
                x = np.loadtxt(f, encoding="UTF-8", dtype=np.str)
    ...
    def test_utf8_userconverters_with_explicit_dtype(self):
        ...
        with temppath() as path:
            ...
            test = np.genfromtxt(path, delimiter=",", names=None, dtype=float,
                                 usecols=(2, 3), converters={2: np.str},
                                 encoding='UTF-8')
