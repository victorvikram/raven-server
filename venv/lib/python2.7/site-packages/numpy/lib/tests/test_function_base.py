...
class TestDelete(object):
    ...
    def _check_inverse_of_slicing(self, indices):
        ...
        if not isinstance(indices, (slice, int, np.integer)):
...
class TestPercentile(object):
    ...
    def test_linear(self):
        ...
        # Test defaults
        assert_equal(np.percentile(list(range(10)), 50), 4.5)

        # explicitly specify interpolation_method 'linear' (the default)
        assert_equal(np.percentile(list(range(10)), 50,
    ...
    def test_midpoint(self):
        assert_equal(np.percentile(list(range(10)), 51,
                                   interpolation='midpoint'), 4.5)
        assert_equal(np.percentile(list(range(11)), 51,
                                   interpolation='midpoint'), 5.5)
        assert_equal(np.percentile(list(range(11)), 50,
                                   interpolation='midpoint'), 5)

    def test_nearest(self):
        assert_equal(np.percentile(list(range(10)), 51,
                                   interpolation='nearest'), 5)
        assert_equal(np.percentile(list(range(10)), 49,
