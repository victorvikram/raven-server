...
class TestRecord(object):
    ...
    def test_refcount_dictionary_setting(self):
        ...
        refcounts = {k: sys.getrefcount(i) for k, i in list(d.items())}
        np.dtype(d)
        refcounts_new = {k: sys.getrefcount(i) for k, i in list(d.items())}
...
class TestDtypeAttributes(object):
    ...
    @pytest.mark.parametrize('t', list(np.typeDict.values()))
