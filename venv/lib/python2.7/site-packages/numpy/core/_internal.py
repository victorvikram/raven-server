...
def __dtype_from_pep3118(stream, is_subdtype):
    ...
    while stream:
        ...
        elif stream.__next__ in type_map_chars:
            if stream.__next__ == 'Z':
        ...
        elif stream.__next__ in _pep3118_unsupported_map:
            desc = _pep3118_unsupported_map[stream.__next__]
            raise NotImplementedError(
                "Unrepresentable PEP 3118 data type {!r} ({})"
                .format(stream.__next__, desc))
        else:
