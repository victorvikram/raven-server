...
class SparseFeatureHash(ModelLayer):
    ...
    def add_ops(self, net):
        ...
        if schema.equal_schemas(self.output_schema, IdList):
            input_blob = list(self.input_record.items())
            output_blob = list(self.output_schema.items())
        elif schema.equal_schemas(self.output_schema, IdScoreList):
            input_blob = list(self.input_record.keys())
            output_blob = list(self.output_schema.keys())
            net.Copy(
                list(self.input_record.values()),
                list(self.output_schema.values())
            )
        else:
