...
class AnyExpTrainer(object):
    ...
    def __init__(self, opts):
        ...
        self.xpus = list(range(first_xpu, first_xpu + num_xpus))
    ...
    def extendMetricsOutput(self):
        ...
        if not metrics_output:
            ...
            for metric, value in list(self.metrics.items()):
    ...
    def list_of_epochs(self):
        ...
        return list(range(self.epoch, iter_end_point))

    def list_of_epoch_iters(self):
        return list(range(0, self.epoch_iterations))
