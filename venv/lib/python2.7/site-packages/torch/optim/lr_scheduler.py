...
class _LRScheduler(object):
    ...
    def state_dict(self):
        ...
        """
        return {key: value for key, value in list(self.__dict__.items()) if key != 'optimizer'}
...
class LambdaLR(_LRScheduler):
    ...
    def state_dict(self):
        ...
        state_dict = {key: value for key, value in list(self.__dict__.items()) if key not in ('optimizer', 'lr_lambdas')}
    ...
    * "exp_range": A cycle that scales initial amplitude by :math:`\text{gamma}^{\text{cycle iterations}}`
    ...
    def __init__(self,
        ...
        if cycle_momentum:
            ...
            self.base_momentums = list([group['momentum'] for group in optimizer.param_groups])
