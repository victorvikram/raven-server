...
class Sequential(Module):
    ...
    def __getitem__(self, idx):
        if isinstance(idx, slice):
            ...
            return self._get_item_by_idx(list(self._modules.values()), idx)

    def __setitem__(self, idx, module):
        key = self._get_item_by_idx(list(self._modules.keys()), idx)
...
class ModuleList(Module):
    ...
    def __delitem__(self, idx):
        ...
        self._modules = OrderedDict(list(zip(str_indices, list(self._modules.values()))))
...
class ParameterDict(Module):
    ...
    * in :meth:`~torch.nn.ParameterDict.update`, the order of the merged ``OrderedDict``
    ...
    def __iter__(self):
        return iter(list(self._parameters.keys()))
    ...
    def update(self, parameters):
        ...
        if isinstance(parameters, container_abcs.Mapping):
            if isinstance(parameters, (OrderedDict, ParameterDict)):
                for key, parameter in list(parameters.items()):
                    self[key] = parameter
            else:
