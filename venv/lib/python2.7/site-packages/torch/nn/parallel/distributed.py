...
def _find_tensors(obj):
    ...
    if isinstance(obj, (list, tuple)):
        return itertools.chain(*list(map(_find_tensors, obj)))
    if isinstance(obj, dict):
        return itertools.chain(*list(map(_find_tensors, list(obj.values()))))
    return []
...
class DistributedDataParallel(Module):
    ...
    def __init__(self, module, device_ids=None,
        ...
        if not self.is_cuda or self.is_multi_device_module:
            ...
            self.device_ids = list([_get_device_index(x, True) for x in device_ids])
    ...
    def _ddp_init_helper(self):
        ...
        modules_and_parameters = [
            [
                ...
                for parameter in [parameter for parameter in module.parameters(recurse=False) if parameter.requires_grad]
