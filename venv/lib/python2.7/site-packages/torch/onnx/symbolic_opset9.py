...
def unfold(g, input, dimension, size, step):
    ...
    if input.isCompleteTensor():
        ...
        low_indices = list(range(0, sizedim, step))
        hi_indices = list(range(size, sizedim + 1, step))
...
for k, v in list(sym_help.cast_pytorch_to_onnx.items()):
...
def _generic_rnn(g, variant, input, initial_states, all_weights, has_biases,
    ...
    variantToOnnxActivationMap = dict(list(zip([act_fun.lower() for act_fun in onnxActivations], onnxActivations)))
