...
class SummaryWriter(object):
    ...
    def add_hparams(self, hparam_dict=None, metric_dict=None):
        ...
        with SummaryWriter(log_dir=logdir) as w_hp:
            ...
            for k, v in list(metric_dict.items()):
                w_hp.add_scalar(k, v)
    ...
    def add_scalars(self, main_tag, tag_scalar_dict, global_step=None, walltime=None):
        ...
        for tag, scalar_value in list(tag_scalar_dict.items()):
            fw_tag = fw_logdir + "/" + main_tag.replace("/", "_") + "_" + tag
            if fw_tag in list(self.all_writers.keys()):
    ...
    def flush(self):
        ...
        if self.all_writers is None:
            return
        for writer in list(self.all_writers.values()):
            writer.flush()
