...
class BuildExtension(build_ext, object):
    ...
    def _add_compile_flag(self, extension, flag):
        ...
        if isinstance(extension.extra_compile_args, dict):
            for args in list(extension.extra_compile_args.values()):
                args.append(flag)
        else:
        ...
        if isinstance(functions, list):
            ...
            raise ValueError(
                "Expected 'functions' to be a list or dict, but was {}".format(
                    type(functions)))
        for function_name, docstring in list(functions.items()):
...
def _get_cuda_arch_flags(cflags=None):
    ...
    if not arch_list:
        ...
        # Expand named arches
        for named_arch, archval in list(named_arches.items()):
