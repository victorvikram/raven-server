...
def build_center_single(entity_constraint=None):
    # Build AoT here
    root = Root("Scene")
...
def build_distribute_four(num_min=0, rand_positions=True):
    # Build AoT here
    root = Root("Scene")
    ...
    layout_constraint = gen_layout_constraint("planar",
                                              ...
                                              num_min=num_min,
                                              num_max=3)
    layout = Layout("Distribute_Four", layout_constraint, entity_constraint, rand_positions=rand_positions)
    comp.insert(layout)
...
def build_distribute_nine(num_min=0, rand_positions=True):
    # Build AoT here
    root = Root("Scene")
    ...
    layout_constraint = gen_layout_constraint("planar", 
                                              ...
                                              num_min=num_min,
                                              num_max=8)
    layout = Layout("Distribute_Nine", layout_constraint, entity_constraint, rand_positions=rand_positions)
    comp.insert(layout)
...
def build_in_distribute_four_out_center_single(num_min=0, rand_positions=True):
    # Build AoT here
    root = Root("Scene")
    ...
    layout_constraint = gen_layout_constraint("planar",
                                              ...
                                              num_min=num_min,
                                              num_max=3)
    layout = Layout("In_Distribute_Four", layout_constraint, entity_constraint, rand_positions=rand_positions)
    comp_in.insert(layout)
