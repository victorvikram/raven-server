...
class Layout(AoTNode):
    ...
    def __init__(self, name, layout_constraint, entity_constraint, 
                             ...
                             sample_new_num_count=None, is_pg=False, rand_positions=True):
        ...
        self.position = Position(pos_type=layout_constraint["Position"][0], pos_list=layout_constraint["Position"][1], rand_positions=rand_positions)
